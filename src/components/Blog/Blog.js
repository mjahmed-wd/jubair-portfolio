...
const Blog = () => {
  const allPosts=[
  ...
  },
    {
      ...
      Undefined is a variable that has been declared, but no value is assigned to it. Where  .....`,postURL: `https://mjubairahmed.medium.com/10-javascript-concepts-that-every-javascript-programmer-must-know-61ba2b2c6709?source=your_stories_page-------------------------------------`
  },
    {
      ...
      postBody: `If you are an absolute beginner or middle of learning React js, then this blog is made for you. Here .....`,postURL: `https://mjubairahmed.medium.com/fundamentals-of-react-js-bc0e4090330c`
  },
]
  return (
